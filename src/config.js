...
export const DIFFICULTIES = {
  story: { ar: 'حكاية', en: 'Story', monsterSpeed: 0.8, hearing: 0.7, sight: 0.8, adapt: 0.5, hourSeconds: 240, batterySeconds: 420, bells: 4, batteries: 3, salt: 2, bead: 0.6, hints: 'full', lockedDoors: 1 },
  normal: { ar: 'ليلة عادية', en: 'Normal night', monsterSpeed: 1, hearing: 1, sight: 1, adapt: 1, hourSeconds: 180, batterySeconds: 300, bells: 3, batteries: 2, salt: 2, bead: 0.3, hints: 'some', lockedDoors: 2 },
  friday: { ar: 'ليلة الجمعة', en: 'Friday night', monsterSpeed: 1.15, hearing: 1.25, sight: 1.1, adapt: 1.5, hourSeconds: 150, batterySeconds: 220, bells: 2, batteries: 1, salt: 1, bead: 0.15, hints: 'some', lockedDoors: 2 },
  merciless: { ar: 'بلا رحمة', en: 'Merciless', monsterSpeed: 1.2, hearing: 1.3, sight: 1.15, adapt: 1.6, hourSeconds: 150, batterySeconds: 200, bells: 2, batteries: 1, salt: 1, bead: 0, hints: 'none', permadeath: true, lockedDoors: 3 },
};
...
export const NIGHTS = {
  ...
  2: {
    ...
    doorClose: 0.35, // بتسكّر أبواب وراها أكثر
    extraLocked: 1,
  },
};
...
export function nightConfig(diff, night) {
  ...
  const cfg = {
    ...diff,
    night,
    lightsOut: n.lightsOut ?? 0.2,
    teleport: !!n.teleport,
    sealed: n.sealed ?? 0,
    doorClose: n.doorClose ?? 0.15,
    lockedDoors: diff.lockedDoors + (n.extraLocked ?? 0),
  };
